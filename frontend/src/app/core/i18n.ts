...
export const TRANSLATIONS: Record<string, Entry> = {
  ...
  'nav.signOutConfirm': { en: 'Are you sure you want to sign out?', ar: 'هل أنت متأكد أنك تريد تسجيل الخروج؟', es: '¿Seguro que quieres cerrar sesión?', fr: 'Voulez-vous vraiment vous déconnecter ?', de: 'Möchten Sie sich wirklich abmelden?', hi: 'क्या आप वाकई साइन आउट करना चाहते हैं?', zh: '确定要退出登录吗？' },
  ...
  'auth.errNotFound': { en: 'No account was found for that email.', ar: 'لم يُعثر على حساب بهذا البريد الإلكتروني.', es: 'No se encontró ninguna cuenta con ese correo.', fr: "Aucun compte n'a été trouvé pour cet e-mail.", de: 'Für diese E-Mail wurde kein Konto gefunden.', hi: 'उस ईमेल के लिए कोई खाता नहीं मिला।', zh: '未找到该电子邮件对应的账户。' },
  'auth.errUseGoogle': { en: 'This account uses Google sign-in. Please continue with Google.', ar: 'يستخدم هذا الحساب تسجيل الدخول عبر Google. يرجى المتابعة باستخدام Google.', es: 'Esta cuenta usa el inicio de sesión con Google. Continúa con Google.', fr: 'Ce compte utilise la connexion Google. Veuillez continuer avec Google.', de: 'Dieses Konto verwendet die Google-Anmeldung. Bitte mit Google fortfahren.', hi: 'यह खाता Google साइन-इन का उपयोग करता है। कृपया Google से जारी रखें।', zh: '此账户使用 Google 登录。请使用 Google 继续。' },
  'auth.noticeExists': { en: 'You already have an account with this email. Please sign in.', ar: 'لديك حساب بهذا البريد الإلكتروني بالفعل. يرجى تسجيل الدخول.', es: 'Ya tienes una cuenta con este correo. Inicia sesión.', fr: 'Vous avez déjà un compte avec cet e-mail. Veuillez vous connecter.', de: 'Sie haben bereits ein Konto mit dieser E-Mail. Bitte melden Sie sich an.', hi: 'इस ईमेल से आपका पहले से एक खाता है। कृपया साइन इन करें।', zh: '此电子邮件已有账户。请登录。' },

  // ── Email verification ─────────────────────────────────────
  'verify.eyebrow': { en: 'Email verification', ar: 'تأكيد البريد الإلكتروني', es: 'Verificación de correo', fr: "Vérification de l'e-mail", de: 'E-Mail-Bestätigung', hi: 'ईमेल सत्यापन', zh: '电子邮件验证' },
  'verify.checking': { en: 'Confirming your email…', ar: 'جارٍ تأكيد بريدك الإلكتروني…', es: 'Confirmando tu correo…', fr: 'Confirmation de votre e-mail…', de: 'E-Mail wird bestätigt…', hi: 'आपका ईमेल पुष्टि किया जा रहा है…', zh: '正在确认您的电子邮件…' },
  'verify.wait': { en: 'This will only take a moment.', ar: 'لن يستغرق هذا سوى لحظة.', es: 'Esto solo tomará un momento.', fr: 'Cela ne prendra qu\'un instant.', de: 'Das dauert nur einen Moment.', hi: 'इसमें बस एक क्षण लगेगा।', zh: '这只需片刻。' },
  'verify.successTitle': { en: 'Email verified', ar: 'تم تأكيد البريد الإلكتروني', es: 'Correo verificado', fr: 'E-mail vérifié', de: 'E-Mail bestätigt', hi: 'ईमेल सत्यापित', zh: '电子邮件已验证' },
  'verify.successBody': { en: 'Thanks! Taking you to your chat…', ar: 'شكراً! يتم نقلك إلى محادثتك…', es: '¡Gracias! Llevándote a tu chat…', fr: 'Merci ! Redirection vers votre conversation…', de: 'Danke! Sie werden zu Ihrem Chat weitergeleitet…', hi: 'धन्यवाद! आपको आपकी चैट पर ले जाया जा रहा है…', zh: '谢谢！正在带您前往聊天…' },
  'verify.continue': { en: 'Continue to chat', ar: 'المتابعة إلى المحادثة', es: 'Continuar al chat', fr: 'Continuer vers le chat', de: 'Weiter zum Chat', hi: 'चैट पर जाएँ', zh: '前往聊天' },
  'verify.failTitle': { en: 'Verification', ar: 'التحقق', es: 'Verificación', fr: 'Vérification', de: 'Bestätigung', hi: 'सत्यापन', zh: '验证' },
  'verify.failHeading': { en: 'We could not verify this link', ar: 'تعذّر علينا التحقق من هذا الرابط', es: 'No pudimos verificar este enlace', fr: 'Nous n\'avons pas pu vérifier ce lien', de: 'Dieser Link konnte nicht bestätigt werden', hi: 'हम इस लिंक को सत्यापित नहीं कर सके', zh: '我们无法验证此链接' },
  'verify.resend': { en: 'Resend verification email', ar: 'إعادة إرسال بريد التأكيد', es: 'Reenviar correo de verificación', fr: 'Renvoyer l\'e-mail de vérification', de: 'Bestätigungs-E-Mail erneut senden', hi: 'सत्यापन ईमेल फिर से भेजें', zh: '重新发送验证邮件' },
  'verify.resending': { en: 'Sending…', ar: 'جارٍ الإرسال…', es: 'Enviando…', fr: 'Envoi…', de: 'Senden…', hi: 'भेजा जा रहा है…', zh: '正在发送…' },
  'verify.resent': { en: 'If an account needs it, a new email is on its way.', ar: 'إذا كان الحساب بحاجة لذلك، فإن بريداً جديداً في طريقه إليك.', es: 'Si una cuenta lo necesita, un nuevo correo está en camino.', fr: 'Si un compte en a besoin, un nouvel e-mail est en route.', de: 'Falls ein Konto es benötigt, ist eine neue E-Mail unterwegs.', hi: 'यदि किसी खाते को आवश्यकता है, तो एक नया ईमेल भेजा जा रहा है।', zh: '如果账户需要，新邮件正在发送中。' },
  'verify.backToSignIn': { en: 'Back to sign-in', ar: 'العودة إلى تسجيل الدخول', es: 'Volver al inicio de sesión', fr: 'Retour à la connexion', de: 'Zurück zur Anmeldung', hi: 'साइन-इन पर वापस जाएँ', zh: '返回登录' },
  'verify.errMissing': { en: 'This verification link is missing its token.', ar: 'رابط التأكيد هذا يفتقد الرمز.', es: 'A este enlace de verificación le falta el token.', fr: 'Ce lien de vérification n\'a pas de jeton.', de: 'Diesem Bestätigungslink fehlt das Token.', hi: 'इस सत्यापन लिंक में टोकन गायब है।', zh: '此验证链接缺少令牌。' },
  'verify.errInvalid': { en: 'This verification link is invalid or has expired.', ar: 'رابط التأكيد هذا غير صالح أو منتهي الصلاحية.', es: 'Este enlace de verificación no es válido o ha caducado.', fr: 'Ce lien de vérification est invalide ou a expiré.', de: 'Dieser Bestätigungslink ist ungültig oder abgelaufen.', hi: 'यह सत्यापन लिंक अमान्य है या समाप्त हो चुका है।', zh: '此验证链接无效或已过期。' },
  'verify.awaitingTitle': { en: 'Check your inbox', ar: 'تحقق من بريدك الإلكتروني', es: 'Revisa tu correo', fr: 'Vérifiez votre boîte de réception', de: 'Prüfen Sie Ihr Postfach', hi: 'अपना इनबॉक्स देखें', zh: '请查收您的邮箱' },
  'verify.awaitingBody': { en: 'We sent a verification link to {email}. Open it to unlock chat and uploads.', ar: 'أرسلنا رابط تأكيد إلى {email}. افتحه لتفعيل المحادثة والرفع.', es: 'Enviamos un enlace de verificación a {email}. Ábrelo para desbloquear el chat y las cargas.', fr: 'Nous avons envoyé un lien de vérification à {email}. Ouvrez-le pour débloquer le chat et les téléchargements.', de: 'Wir haben einen Bestätigungslink an {email} gesendet. Öffnen Sie ihn, um Chat und Uploads freizuschalten.', hi: 'हमने {email} पर एक सत्यापन लिंक भेजा है। चैट और अपलोड अनलॉक करने के लिए इसे खोलें।', zh: '我们已向 {email} 发送了验证链接。打开它即可解锁聊天和上传。' },
  'verify.awaitingHint': { en: 'Open the link on this device and you will be taken straight to your chat. Did not get it? Resend below.', ar: 'افتح الرابط على هذا الجهاز وسيتم نقلك مباشرة إلى محادثتك. لم يصلك؟ أعد الإرسال أدناه.', es: 'Abre el enlace en este dispositivo y pasarás directamente a tu chat. ¿No lo recibiste? Reenvíalo abajo.', fr: 'Ouvrez le lien sur cet appareil pour accéder directement à votre chat. Pas reçu ? Renvoyez-le ci-dessous.', de: 'Öffnen Sie den Link auf diesem Gerät, um direkt zu Ihrem Chat zu gelangen. Nicht erhalten? Unten erneut senden.', hi: 'इस डिवाइस पर लिंक खोलें और आप सीधे अपनी चैट पर पहुँच जाएँगे। नहीं मिला? नीचे फिर से भेजें।', zh: '在此设备上打开链接，您将直接进入聊天。没收到？在下方重新发送。' },
  ...
  'consent.pendingVerify': { en: 'This email already has a Google account. We sent a link to confirm and enable password sign-in.', ar: 'هذا البريد لديه حساب Google بالفعل. أرسلنا رابطاً للتأكيد وتفعيل تسجيل الدخول بكلمة المرور.', es: 'Este correo ya tiene una cuenta de Google. Enviamos un enlace para confirmar y habilitar el inicio de sesión con contraseña.', fr: 'Cet e-mail a déjà un compte Google. Nous avons envoyé un lien pour confirmer et activer la connexion par mot de passe.', de: 'Diese E-Mail hat bereits ein Google-Konto. Wir haben einen Link gesendet, um die Passwort-Anmeldung zu bestätigen und zu aktivieren.', hi: 'इस ईमेल का पहले से Google खाता है। हमने पासवर्ड साइन-इन की पुष्टि और सक्रिय करने के लिए एक लिंक भेजा है।', zh: '此电子邮件已有 Google 账户。我们已发送链接以确认并启用密码登录。' },
  'consent.haveAccount': { en: 'Already have an account?' },
  ...
  'chat.verifyBanner': { en: 'Please verify your email to start chatting and uploading.', ar: 'يرجى تأكيد بريدك الإلكتروني لبدء المحادثة والتحميل.', es: 'Verifica tu correo para empezar a chatear y subir archivos.', fr: 'Veuillez vérifier votre e-mail pour discuter et téléverser.', de: 'Bitte bestätigen Sie Ihre E-Mail, um zu chatten und hochzuladen.', hi: 'चैट और अपलोड शुरू करने के लिए कृपया अपना ईमेल सत्यापित करें।', zh: '请验证您的电子邮件以开始聊天和上传。' },
  ...
  // ── Delete account ─────────────────────────────────────────
  'settings.deleteTitle': { en: 'Delete account', ar: 'حذف الحساب', es: 'Eliminar cuenta', fr: 'Supprimer le compte', de: 'Konto löschen', hi: 'खाता हटाएं', zh: '删除账户' },
  'settings.deleteDesc': { en: 'Permanently delete your account, chat history, and profile data. This cannot be undone.', ar: 'احذف حسابك وسجل المحادثات وبيانات ملفك الشخصي نهائياً. لا يمكن التراجع عن ذلك.', es: 'Elimina permanentemente tu cuenta, el historial de chat y los datos de perfil. No se puede deshacer.', fr: 'Supprimez définitivement votre compte, votre historique de chat et vos données de profil. Cette action est irréversible.', de: 'Löschen Sie Ihr Konto, den Chatverlauf und die Profildaten dauerhaft. Dies kann nicht rückgängig gemacht werden.', hi: 'अपना खाता, चैट इतिहास और प्रोफ़ाइल डेटा स्थायी रूप से हटाएं। इसे पूर्ववत नहीं किया जा सकता।', zh: '永久删除您的账户、聊天记录和个人资料数据。此操作无法撤销。' },
  'settings.deleteButton': { en: 'Delete account', ar: 'حذف الحساب', es: 'Eliminar cuenta', fr: 'Supprimer le compte', de: 'Konto löschen', hi: 'खाता हटाएं', zh: '删除账户' },
  'settings.deleteWarning': { en: 'This permanently deletes everything in your account. This action cannot be undone.', ar: 'سيؤدي هذا إلى حذف كل ما في حسابك نهائياً. لا يمكن التراجع عن هذا الإجراء.', es: 'Esto elimina permanentemente todo en tu cuenta. Esta acción no se puede deshacer.', fr: 'Cela supprime définitivement tout ce qui se trouve dans votre compte. Cette action est irréversible.', de: 'Dadurch wird alles in Ihrem Konto dauerhaft gelöscht. Diese Aktion kann nicht rückgängig gemacht werden.', hi: 'यह आपके खाते में सब कुछ स्थायी रूप से हटा देता है। इस क्रिया को पूर्ववत नहीं किया जा सकता।', zh: '这将永久删除您账户中的所有内容。此操作无法撤销。' },
  'settings.deletePromptLabel': { en: 'Type DELETE to confirm', ar: 'اكتب DELETE للتأكيد', es: 'Escribe DELETE para confirmar', fr: 'Tapez DELETE pour confirmer', de: 'Geben Sie DELETE ein, um zu bestätigen', hi: 'पुष्टि के लिए DELETE टाइप करें', zh: '输入 DELETE 以确认' },
  'settings.deleteConfirmButton': { en: 'Permanently delete', ar: 'حذف نهائي', es: 'Eliminar permanentemente', fr: 'Supprimer définitivement', de: 'Endgültig löschen', hi: 'स्थायी रूप से हटाएं', zh: '永久删除' },
  'settings.deleting': { en: 'Deleting…', ar: 'جارٍ الحذف…', es: 'Eliminando…', fr: 'Suppression…', de: 'Wird gelöscht…', hi: 'हटाया जा रहा है…', zh: '正在删除…' },
  'settings.deleteCancel': { en: 'Cancel', ar: 'إلغاء', es: 'Cancelar', fr: 'Annuler', de: 'Abbrechen', hi: 'रद्द करें', zh: '取消' },
  'settings.deleteMismatch': { en: 'Type DELETE in capital letters to confirm.', ar: 'اكتب DELETE بأحرف كبيرة للتأكيد.', es: 'Escribe DELETE en mayúsculas para confirmar.', fr: 'Tapez DELETE en majuscules pour confirmer.', de: 'Geben Sie DELETE in Großbuchstaben ein, um zu bestätigen.', hi: 'पुष्टि के लिए DELETE बड़े अक्षरों में टाइप करें।', zh: '请用大写字母输入 DELETE 以确认。' },
  'settings.deleteFinalConfirm': { en: 'Are you absolutely sure you want to permanently delete your account?', ar: 'هل أنت متأكد تماماً أنك تريد حذف حسابك نهائياً؟', es: '¿Estás absolutamente seguro de que quieres eliminar tu cuenta permanentemente?', fr: 'Êtes-vous absolument sûr de vouloir supprimer définitivement votre compte ?', de: 'Sind Sie absolut sicher, dass Sie Ihr Konto endgültig löschen möchten?', hi: 'क्या आप वाकई अपना खाता स्थायी रूप से हटाना चाहते हैं?', zh: '您确定要永久删除您的账户吗？' },
  'settings.deleteFailed': { en: 'We could not delete your account. Please try again.', ar: 'تعذّر حذف حسابك. يرجى المحاولة مرة أخرى.', es: 'No pudimos eliminar tu cuenta. Inténtalo de nuevo.', fr: 'Nous n\'avons pas pu supprimer votre compte. Veuillez réessayer.', de: 'Ihr Konto konnte nicht gelöscht werden. Bitte versuchen Sie es erneut.', hi: 'हम आपका खाता नहीं हटा सके। कृपया पुनः प्रयास करें।', zh: '无法删除您的账户。请重试。' }
};
